...
public class ActionDaoJdbcImpl implements ActionDao
{
	...
	private void createTables()
	{
		try
		{
		   this.template.update("CREATE TABLE ACTION (ACTION_ID integer generated by default as identity (start with 1), DETAILS VARCHAR(255), COMPLETE BOOLEAN, OWNING_USER VARCHAR(60), REQUIRED_BY DATE)");
		}
